...
const url = "https://sample.herokuapp.com/api/Beats"
http.get(url);
```

```swift
let url = URL(string: "https://alertsizen.herokuapp.com/api/beats")
...
```shell
curl https://sample.herokuapp.com/api/beats
...
This endpoint retrieves all Beats.

### HTTP Request

`GET https://sample.herokuapp.com/api/Beats`
